...
import com.example.sxb.mywechat.ChatActivity;
   ...
   //2.定义ViewHolder(视图容器)
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            friend=itemView.findViewById(R.id.tv_friend);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //将条目布局文件填充成View对象
        View itemView= View.inflate(parent.getContext(),R.layout.item_msg,null);
